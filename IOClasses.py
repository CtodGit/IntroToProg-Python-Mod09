...
# CTod,6.17.2020, Used for module labs
# CTod,6.18.2020, Used for module assignment
# CTod,6.18.2020, modified print current list function
# ---------------------------------------------------------- #
...
class EmployeeIO:
    ...
    def print_current_list_items(list_of_rows: list):
        ...
        for row in list_of_rows:
            emp = row  # Modified original listing code, couldn't get original code to work
            print(f'{emp.employee_id}, {emp.first_name}, {emp.last_name}')  # formatted f string
        print("*******************************************")
        print()  # Add an extra line for looks
